...
export const SizeForm: React.FC<SizeFormProps> = ({ initialData }) => {
  ...
  const title = initialData ? "Edit Size/Publisher" : "Create Size/Publisher";
  const description = initialData
    ? "Edit Size/Publisher"
    : "Add a new Size/Publisher";
        ...
        >
          <div className="grid grid-cols-3 gap-8">
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue placeholder="Select Your Product Size" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                      ...
                      <SelectItem value="Triple Extra Large (XXXL)">
                        Triple Extra Large (XXXL)
                      </SelectItem>
                      <SelectItem value="Quadruple Extra Large (XXXXL)">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Publisher/Author Name</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
                      disabled={loading}
