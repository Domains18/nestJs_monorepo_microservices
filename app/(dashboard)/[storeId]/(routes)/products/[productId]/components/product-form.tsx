...
const formSchema = z.object({
  ...
  .max(1000, {
    message: "Product description must not be longer than 1000 characters.",
  }),
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue placeholder="Select Your Product Condition" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                      ...
                      <SelectItem value="Acceptable/Fair ">
                        Acceptable/Fair
                      </SelectItem>
                      <SelectItem value="Vintage">
                        Vintage
                      </SelectItem>
                      <SelectItem value="Unworn/Unused">
                       Unworn/Unused
                      </SelectItem>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 ">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      This product will disappear from the store
                    </FormDescription>
                  </div>
                  <FormMessage />
                </FormItem>
